...
\emph{A titkok felfedésé\/}t, arabul írta. (1943-ban \emph{Khomeyni} ugyanezen
...
leghíresebb közülük a \emph{Levél az utazásról}.
...
Kibla: az ima iránya; Kadr-éj: az elrendelés éjszakája, amikor a Korán leszállt az égből,
és Gábriel kinyilatkoztatta Mohamednek.
}
\poem{Sa`di}{سعدی}{
...
a \emph{Līlāvatī\/}t. Arabul is írt.
}
...
elsősorban ún.~\emph{`âshurâ}-költeményeiről ismert,
melyek az i.sz.~680-as kerbelai ütközetben elesett \emph{Huseyn} imámhoz írt elégiák.
Fő műve \emph{A gyülekezet gyertyája} c.~verseskötet.
}
...
újságíró és történész. A Teherán Egyetemen irodalmat tanított, és egy irodalmi folyóiratot
is létesített.
...
$\quad$ Hallgasd meg ezt az érvelést, hogy megszabadulj bánatodtól:\\
\emph{khun khori gar talab-ē ruzi-ye nanhâde koni}\\
$\quad$ vért iszol, ha nem [neked] elrendelt megélhetést keresel.\\
\emph{âkherol'amr gel-ē kuzegarân khâhi shod}\\
$\quad$ A végén úgyis a fazekasok agyagja leszel --\\
\emph{hâliyâ fekr-e sabu kon ke por az bâde koni}\\
$\quad$ most gondolj a korsóra, amit borral töltesz tele!
\end{tabular}
}
...
Elsősorban szatíráiról híres.

Ez a vers érdekes párhuzamba állítható a kínai \emph{Szertartások könyvé\/}nek
egy jelenetével, melyben Konfuciusz találkozik egy asszony\-nyal,
aki a zsarnoki uralom elől a tigrisekkel teli erdőbe menekült
(\emph{L\v\i jì: Tán gōng xià 193}).
}
...
%% Hol nincs szerelem, ott aki él is hulla,\\
%% hol nincs szerelem, ott az erős is béna.\\
%% Hol nincs szerelem, ott a király is koldus,\\
%% hol van szerelem, ott a bolond is molla.
%
Vágy nélkül az élő is holt, mint mi kimúlt,\\
vágy nélkül nincsen, ki dicső -- mind nyomorult.\\
Vágy nélkül bármi nagy király is koldus:\\
vággyal kap a béna is parancsnok-koszorút.
%
%% Forró szerelem nélkül holt mind, aki él,\\
%% forró szerelem nélkül a nagy hős is fél.\\
%% Forró szerelem nélkül a felség koldus,\\
%% forró szerelemtől a puhány karja acél.
}{
...
hajszálammal vágyom rád őrülten.\\
...
Fontos szerepe volt
a \emph{Fajr} nemzetközi filmfesztivál, a \emph{Farabi} filmművészeti alapítvány
